<?php /*
Template Name: Chicoran Categories
Theme Name: CHICORA
Author: Austin Serio
...
<div class="col-xs-12 hero parallax-window" id="post-hero" data-parallax="scroll" data-bleed="" data-image-src="<?php echo $url ?>">
		...
		<div id="title-container wow fadeIn">
		  ...
		  <div id="nav-title">
				<p class="wow fadeIn" data-wow-delay="2s">featured story</p>
		  </div>
		</div>
...
<div class="col-xs-12 content-container">
	<div id="post-subheader" class="section-subheader"><span class="horizontal-center"><?php echo get_field('english_title'); ?></span></div>
	<h2 class="post-title" style="text-transform: lowercase;"><?php echo esc_html( $postcat[0]->name ); ?></h2>
	<div id="category-body" class="col-md-10 col-md-offset-1 col-sm-12 col-sm-offset-0 content-body wow fadeInUp" style="padding-bottom: 25px;">

		<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
			<?php $post_bg_url = wp_get_attachment_url( get_post_thumbnail_id($post), 'thumbnail' ); ?>
			<a href="<?php the_permalink(); ?>">
				<div class="col-xs-12 post-listing wow zoomIn" style="background: url(<?php echo $post_bg_url ?>) no-repeat;">
